            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        Label("AI-Generated Imagery", systemImage: "sparkles")
                            .font(.yogaHeadline())

                        Text("Pose illustrations in YogaGeek are generated by artificial intelligence and are intended for instructional reference only. They do not depict real individuals.")
                            .font(.subheadline)
                            .foregroundStyle(.secondary)
                    ...
                    VStack(spacing: 0) {
                        InfoRow(label: "Developer", value: "Chang Sun")
                        Divider().padding(.leading, 16)
                        InfoRow(label: "Website", value: "yogatechie.com")
                        Divider().padding(.leading, 16)
                        InfoRow(label: "Support", value: "support@yogatechie.com")
                    }
                    .background(Color.yogaCardBackground)
                    .clipShape(RoundedRectangle(cornerRadius: 12))
                }
